...
export function Footer() {
  return (
    <footer id="contact" className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 grid md:grid-cols-5 gap-10">
        ...
        <div>
          <div className="text-xs uppercase tracking-widest text-neutral-500 mb-3">Legal</div>
          <ul className="space-y-2 text-sm text-neutral-300">
            <li><Link to="/privacy" className="hover:text-white">Privacy Policy</Link></li>
            <li><Link to="/returns" className="hover:text-white">Return & Refund Policy</Link></li>
