...
import type { Product } from "./cart-store";
import { getProducts } from "@/services/contentful"; // Adjust this relative path if your contentful file is in a different folder
=======
import type { Product } from "./cart-store";
...
<<<<<<< HEAD
// Fetch and export the live products directly from Contentful
